...
const Accessories = () => {
    ...
    return (
        <section id="accessories" className="py-24 bg-brand-black relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                    <div>
                        ...
                        <p className="text-gray-400 text-lg">Premium accessories to enhance your device.</p>
                    </div>
                    <button className="text-brand-green font-semibold hover:text-white transition-colors">View All Accessories &rarr;</button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {categories.map((item, index) => (
                        <motion.div
                            ...
                            className="group relative h-[400px] rounded-3xl overflow-hidden bg-gray-900 border border-white/10"
                        >
                            {/* Background Image */}
                            <img
                                src={item.image}
